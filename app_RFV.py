...
def main():
    ...
    if (data_file_1 is not None):
        ...
        'ABA': 'Enviar cupons de desconto menor, Pedir para indicar nosso produto pra algum amigo',
        'ABB': 'Enviar cupons de desconto bem menor, Pedir para indicar nosso produto pra algum amigo',
